"""
Django settings for free-traveler project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (free_traveler/config/settings/base.py - 3 = free_traveler/)
APPS_DIR = ROOT_DIR.path('free_traveler')
...
LOCAL_APPS = [
    # custom users app
    'free_traveler.users.apps.UsersConfig',
    # Your stuff: custom apps go here
    'free_traveler.traveler.apps.TravelerConfig',
]
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'free_traveler.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///free_traveler'),
}
...
ACCOUNT_ADAPTER = 'free_traveler.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'free_traveler.users.adapters.SocialAccountAdapter'
...
########## CELERY
INSTALLED_APPS += ['free_traveler.taskapp.celery.CeleryConfig']
